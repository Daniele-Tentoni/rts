...
SOLDIER_C_1 = (100, 100, 255)
SOLDIER_C_2 = (100, 255, 100)
...
defaults = {
    ...
    "player": {
        # get if it's the first time player use this game
        "first_time": int(True)
    },
}
...
def get_first_time_player() -> bool:
    return _get("player.first_time")


def set_first_time_player(value: bool):
    _set("player.first_time", value)
